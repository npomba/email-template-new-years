    ...
    <Container alignment='center' style={stls.container}>
      <Row>
        <Column style={stls.column}>
          <p style={stls.p}>
            В канун Нового года мы все строим планы на будущее, <br />даем себе новые{' '}
            обещания. <br />А еще это{' '}
            <span style={stls.strong}>время акций и скидок</span>
          </p>
          <p style={stls.p}>
            Не тратьте деньги на ненужные вещи — <br /> купите понравившуюся{' '}
            программу обучения <br /><span style={stls.strong}>с выгодой</span> и
            сделайте шаг навстречу переменам. <br /> Вложения в себя всегда
            окупаются!
          </p>
          <p style={stls.pLarge}>
            Выберите программу обучения, <br /> которая изменит Вашу жизнь!
          </p>
        </Column>
      </Row>
    </Container>
